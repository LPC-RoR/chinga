class AutoresController < ApplicationController
  ...
  # GET /autores or /autores.json
  def index
    @autores = Autor.all
  end

  # GET /autores/1 or /autores/1.json
  def show
  end
  ...
  # PATCH/PUT /autores/1 or /autores/1.json
  def update
    respond_to do |format|
  ...
  # DELETE /autores/1 or /autores/1.json
  def destroy
    @autor.destroy
    respond_to do |format|
  ...
  private
    ...
    def autor_params
      params.require(:autor).permit(:autor, :perfil_id)
    end
end
