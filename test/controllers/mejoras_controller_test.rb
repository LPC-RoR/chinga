...
class MejorasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mejora" do
    assert_difference('Mejora.count') do
      post mejoras_url, params: { mejora: { detalle: @mejora.detalle, elemento_id: @mejora.elemento_id, mejora: @mejora.mejora, owner_id: @mejora.owner_id } }
    end
  ...
  test "should update mejora" do
    patch mejora_url(@mejora), params: { mejora: { detalle: @mejora.detalle, elemento_id: @mejora.elemento_id, mejora: @mejora.mejora, owner_id: @mejora.owner_id } }
