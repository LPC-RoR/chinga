...
class ContribucionesControllerTest < ActionDispatch::IntegrationTest
  setup do
    @contribucion = contribuciones(:one)
  end

  test "should get index" do
    get contribuciones_url
  ...
  test "should create contribucion" do
    assert_difference('Contribucion.count') do
      post contribuciones_url, params: { contribucion: {  } }
    end
  ...
  test "should update contribucion" do
    patch contribucion_url(@contribucion), params: { contribucion: {  } }
  ...
  test "should destroy contribucion" do
    ...
    assert_redirected_to contribuciones_url
  end
end
