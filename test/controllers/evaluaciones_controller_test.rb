...
class EvaluacionesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evaluacion" do
    assert_difference('Evaluacion.count') do
      post evaluaciones_url, params: { evaluacion: { aspecto: @evaluacion.aspecto, elemento_id: @evaluacion.elemento_id, evaluacion: @evaluacion.evaluacion, perfil_id: @evaluacion.perfil_id } }
    end
  ...
  test "should update evaluacion" do
    patch evaluacion_url(@evaluacion), params: { evaluacion: { aspecto: @evaluacion.aspecto, elemento_id: @evaluacion.elemento_id, evaluacion: @evaluacion.evaluacion, perfil_id: @evaluacion.perfil_id } }
