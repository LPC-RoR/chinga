...
class IntegrantesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create integrante" do
    assert_difference('Integrante.count') do
      post integrantes_url, params: { integrante: { equipo_id: @integrante.equipo_id, paerfil_id: @integrante.paerfil_id } }
    end
  ...
  test "should update integrante" do
    patch integrante_url(@integrante), params: { integrante: { equipo_id: @integrante.equipo_id, paerfil_id: @integrante.paerfil_id } }
