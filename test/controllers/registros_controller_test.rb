...
class RegistrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create registro" do
    assert_difference('Registro.count') do
      post registros_url, params: { registro: { elemento_id: @registro.elemento_id, interprete_id: @registro.interprete_id } }
    end
  ...
  test "should update registro" do
    patch registro_url(@registro), params: { registro: { elemento_id: @registro.elemento_id, interprete_id: @registro.interprete_id } }
